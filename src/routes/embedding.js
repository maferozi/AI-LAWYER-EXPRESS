const { createEmbedding, searchEmbedding, getChatMessage, getAllChats, testSearchEmbedding, uploadPdf } = require("../controller/embedding.controller");
...
embedRouter.post('/uploadPdf',  uploadPdf);
